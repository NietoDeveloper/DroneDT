  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-main">
      ...
      <div className="max-w-md w-full z-10">
        ...
        <div className="glass-panel p-10 relative overflow-hidden bg-white/70">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="group">
              ...
              <input 
                type="email" 
                className="w-full p-4 bg-gainsboro border border-transparent rounded-xl focus:border-gold/50 focus:bg-white transition-all duration-300 outline-none text-sm font-medium text-heading"
