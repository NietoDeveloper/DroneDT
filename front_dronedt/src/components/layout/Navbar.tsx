...
const Navbar = () => {
  ...
  const fetchMenuData = useCallback(async () => {
    ...
    try {
      // Timeout de 5 segundos para no dejar al usuario esperando infinito
      ...
      // Aquí podrías cargar un set de datos "Fallback" si el back falla
    } finally {
      // Delay artificial para que el usuario aprecie tu animación de carga de nivel #1
