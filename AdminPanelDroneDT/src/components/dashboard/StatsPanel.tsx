  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 w-full gap-[1px] bg-white/5 border-b border-white/10">
      <StatCard 
        ...
        subLabel={`${stats?.totalStock || 0} UNIDADES EN BÓVEDA`}
        delay={0.1}
      />
      ...
      <StatCard 
        ...
        trend="EN VIVO"
        subLabel={`${stats?.totalSold || 0} ACTIVOS LIQUIDADOS`}
        delay={0.2}
      />
      ...
      <StatCard 
        ...
        subLabel="PRECIO DE MERCADO INDEXADO"
        delay={0.3}
      />
      ...
      <StatCard 
        ...
        subLabel={`UNIDADES VINCULADAS: ${products?.length || 0}`}
        isStatus
        delay={0.4}
      />
    </div>
