...
export default function DroneDashboardPage() {
  ...
  useEffect(() => {
    // Orquestación temporal: El preloader libera la pantalla tras 3.5 segundos exactos
  ...
  // INTERFAZ INICIAL: Preloader de carga profunda del núcleo
  ...
  return (
    <div className="fluid-container h-screen w-screen flex flex-col bg-[#050505] text-white overflow-hidden relative select-none font-mono">
      ...
      <AnimatePresence mode="wait">
        {/* INTERFAZ 1: GATEWAY DE INGRESO (BYPASS DIRECTO AL PULSAR EL BOTÓN) */}
        {currentFlow === 'LOGIN' && (
          <motion.div
            key="login-interface"
          ...
          >
            <div className="w-full max-w-sm sm:max-w-md bg-zinc-950/40 border border-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.9)]">
              ...
              {/* BOTÓN INDUSTRIAL GOLD (#FFD700) CON REDIRECCIÓN DIRECTA AL DASHBOARD */}
              <button
        ...
        {/* INTERFAZ 2: CONTROL CENTER DASHBOARD COMPLETAMENTE RESPONSIVO (310PX - 1900PX) */}
